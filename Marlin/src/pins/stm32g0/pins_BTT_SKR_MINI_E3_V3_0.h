...
// SPI Pins
#define TFT_SCK_PIN  PA5   // Serial Clock
#define TFT_MOSI_PIN PA7   // Master Out Slave In
#define TFT_CS_PIN   PB6   // Chip Select
#define TFT_DC_PIN   PB7   // Data/Command
#define TFT_RST_PIN  PB8   // Reset
